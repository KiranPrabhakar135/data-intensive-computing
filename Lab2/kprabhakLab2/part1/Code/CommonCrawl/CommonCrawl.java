...
public class CommonCrawl {
    public static void main(String[] args) throws IOException,  InterruptedException {
        ...
        String s3File = "test.txt";
        String content = "asdf1";

         // putToS3Bucket(bucketName, accessKey, secretKey, s3File, content);


        readCCDataFromS31("crawl-data/CC-MAIN-2019-13/segments/1552912202523.0/wat/CC-MAIN-20190321112407-20190321134407-00422.warc.wat.gz", 0);
    ...
    private static void processWetFiles() throws  IOException {
    ...
    private static void getCCUrls() throws IOException, InterruptedException {
        ...
        String[] subtopics = new String[]{"facebook"};//{"Amazon", "Google", "Tesla", "Apple", "microsoft"};//{"Tesla", "Nvidia", "Cisco", "adobe", "microsoft"};
...
//    }
    ...
    private static List<Integer> readCCDataFromS31(String ccUrl, int urlCount) throws IOException {
